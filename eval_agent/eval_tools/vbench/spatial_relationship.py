...
def spatial_relationship(model, video_pairs, device):
    video_results = []
    frame_score_overall = []
...
def compute_spatial_relationship(video_pairs):
    ...
    results = spatial_relationship(dense_caption_model, video_pairs, device)
    return results
