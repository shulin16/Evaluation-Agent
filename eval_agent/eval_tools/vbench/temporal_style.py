...
def temporal_style(clip_model, video_pairs, tokenizer, device, sample="middle"):
    sim = []
    video_results = []
...
def compute_temporal_style(video_pairs):
    ...
    results = temporal_style(viclip, video_pairs, tokenizer, device)
    return results
